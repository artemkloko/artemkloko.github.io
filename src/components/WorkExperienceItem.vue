  ...
  <div class="grid grid-cols-1 md:grid-cols-12 gap-6 py-6 border-b border-gray-100 last:border-0 break-inside-avoid">
    ...
    <div class="md:col-span-9">
        ...
        <div class="text-sm font-medium text-gray-600 mb-3">
            ...
            <a v-if="experience.company.url" :href="experience.company.url" target="_blank" class="text-blue-500 hover:underline">{{ experience.company.url }}</a>
        ...
        <div class="text-xs text-gray-400 border-t border-gray-100 pt-2 flex gap-2 uppercase tracking-wider">
